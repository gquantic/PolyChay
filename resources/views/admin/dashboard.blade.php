...
@section('content')
    ...
    <script src="{{asset('/js/admin/interface.js')}}"></script>
    <script src="{{asset('/js/admin/filterTable.v1.0.src.js')}}"></script>
                    ...
                    <div class="tab-pane fade show active" id="week" role="tabpanel" aria-labelledby="home-tab">
                        <div class="d-flex align-items-center" style="width:97%;max-width:1200px;display:flex;justify-content:space-between;">
                            ...
                            <div style="position: relative;">
                                ...
                                <div class="table__seach-field">
                                    ...
                                    <ul class="table__seach-param" id="sortname">
                                        ...
                                        <li class="table__seach-param-item show" id="name">
                                            <label><input type="checkbox" name="" value=""><span class="checks"></span><span class="table__seach-name"></span></label>
                                        </li>
                            ...
                            <div style="position: relative;">
                                ...
                                <div class="table__seach-field">
                                    ...
                                    <ul class="table__seach-param" id="sortname">
                                        <li class="table__seach-param-item show">
                                            <label><input type="checkbox" name="" value="all" class="all" onclick="$('#sortname #name:checkbox').pdrop('checked', true);"><span class="checks"></span><span class="table__seach-name">Выделить все</span></label>
                                        </li>
                                        <li class="table__seach-param-item show" id="name">
                        ...
                        <table class="table">
                            ...
                            <tr style="background: rgba(0,0,0,0);">
                                ...
                                <td style="font-weight: bolder;font-size: 24px;"> р.</td>
                                <td></td>
                                <td style="font-weight: bolder;font-size: 24px;">  р.</td>
                                <td></td>
                                <td></td>
